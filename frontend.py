...
class grid(MDApp):
    ...
    def build(self):
        ...
        #     # size_hint=(0, 0),
        #     # padding=[200,0,10,0],
        #     # padding=[120, 20, 60, 100],
        #     rows_num=2,
        #     column_data=[
        #         ("Description", dp(40)),
        #         ("Interaction Rule Set", dp(60)),
        #         ("Technique", dp(40))
        #     ]
        # )
        self.data_table = MDDataTable(
